...
app.get("/Birdmanor(TheUnexpectedVirtueofIgnorance)", function (req, res) {res.render("html_film_views/Birdmanor(TheUnexpectedVirtueofIgnorance)")})
...
app.get("/DayoftheDead:Bloodline", function (req, res) {res.render("html_film_views/DayoftheDead:Bloodline")})
...
app.get("/LifeofPi", function (req, res) {res.render("html_film_views/LifeofPi")})


app.get("/Pleasantville", function (req, res) {res.render("html_film_views/Pleasantville")})

app.get("/ThePredator", function (req, res) {res.render("html_film_views/ThePredator")})
...
app.get("/TheCalloftheWild", function (req, res) {res.render("html_film_views/TheCalloftheWild")})
