...
app.get("/ApocalypseNowRedux", function (req, res) {res.render("html_film_views/ApocalypseNowRedux", { version: version })})
...
app.get("/birdman", function (req, res) {res.render("html_film_views/birdman", { version: version })})
...
app.get("/TheWorldIsNotEnough", function (req, res) {res.render("html_film_views/TheWorldIsNotEnough", { version: version })})
