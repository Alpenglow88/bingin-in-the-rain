...
app.get("/2001:ASpaceOdyssey", function (req, res) {res.render("html_film_views/2001:ASpaceOdyssey", { version: version })})
...
app.get("/AdAstra", function (req, res) {res.render("html_film_views/AdAstra", { version: version })})
...
app.get("/AnEducation", function (req, res) {res.render("html_film_views/AnEducation", { version: version })})
...
app.get("/Bill&Ted'sExcellentAdventure", function (req, res) {res.render("html_film_views/Bill&Ted'sExcellentAdventure", { version: version })})
...
app.get("/BlueIstheWarmestColor", function (req, res) {res.render("html_film_views/BlueIstheWarmestColor", { version: version })})
...
app.get("/Byzantium", function (req, res) {res.render("html_film_views/Byzantium", { version: version })})
...
app.get("/Cats", function (req, res) {res.render("html_film_views/Cats", { version: version })})
...
app.get("/Everest", function (req, res) {res.render("html_film_views/Everest", { version: version })})
...
app.get("/HarryPotterandtheSorcerer’sStoneRemake", function (req, res) {res.render("html_film_views/HarryPotterandtheSorcerer’sStoneRemake", { version: version })})
...
app.get("/HellBaby", function (req, res) {res.render("html_film_views/HellBaby", { version: version })})
...
app.get("/Hick", function (req, res) {res.render("html_film_views/Hick", { version: version })})
...
app.get("/Horns", function (req, res) {res.render("html_film_views/Horns", { version: version })})
...
app.get("/Lossilencios", function (req, res) {res.render("html_film_views/Lossilencios", { version: version })})
...
app.get("/Mongol:TheRiseofGenghisKhan", function (req, res) {res.render("html_film_views/Mongol:TheRiseofGenghisKhan", { version: version })})
...
app.get("/Museo", function (req, res) {res.render("html_film_views/Museo", { version: version })})
...
app.get("/Oldboy", function (req, res) {res.render("html_film_views/Oldboy", { version: version })})
...
app.get("/Perfume:TheStoryofaMurderer", function (req, res) {res.render("html_film_views/Perfume:TheStoryofaMurderer", { version: version })})
...
app.get("/Rabbit-ProofFence", function (req, res) {res.render("html_film_views/Rabbit-ProofFence", { version: version })})
...
app.get("/Ringu", function (req, res) {res.render("html_film_views/Ringu", { version: version })})


app.get("/RustandBone", function (req, res) {res.render("html_film_views/RustandBone", { version: version })})


app.get("/SafetyNotGuaranteed", function (req, res) {res.render("html_film_views/SafetyNotGuaranteed", { version: version })})


app.get("/Scratch", function (req, res) {res.render("html_film_views/Scratch", { version: version })})
...
app.get("/Sightseers", function (req, res) {res.render("html_film_views/Sightseers", { version: version })})


app.get("/Silence", function (req, res) {res.render("html_film_views/Silence", { version: version })})


app.get("/Sing", function (req, res) {res.render("html_film_views/Sing", { version: version })})
...
app.get("/SonictheHedgehog", function (req, res) {res.render("html_film_views/SonictheHedgehog", { version: version })})
...
app.get("/SympathyforLadyVengeance", function (req, res) {res.render("html_film_views/SympathyforLadyVengeance", { version: version })})


app.get("/SympathyforMr.Vengeance", function (req, res) {res.render("html_film_views/SympathyforMr.Vengeance", { version: version })})


app.get("/TeAta", function (req, res) {res.render("html_film_views/TeAta", { version: version })})


app.get("/ThankYouforSmoking", function (req, res) {res.render("html_film_views/ThankYouforSmoking", { version: version })})


app.get("/The13thWarrior", function (req, res) {res.render("html_film_views/The13thWarrior", { version: version })})


app.get("/TheAngels'Share", function (req, res) {res.render("html_film_views/TheAngels'Share", { version: version })})
...
app.get("/TheBirdcage", function (req, res) {res.render("html_film_views/TheBirdcage", { version: version })})
...
app.get("/TheCabinintheWoods", function (req, res) {res.render("html_film_views/TheCabinintheWoods", { version: version })})
...
app.get("/TheFall", function (req, res) {res.render("html_film_views/TheFall", { version: version })})


app.get("/TheFloridaProject", function (req, res) {res.render("html_film_views/TheFloridaProject", { version: version })})


app.get("/TheForgiven", function (req, res) {res.render("html_film_views/TheForgiven", { version: version })})
...
app.get("/TheGood,theBadandtheUgly", function (req, res) {res.render("html_film_views/TheGood,theBadandtheUgly", { version: version })})
...
app.get("/TheImposter", function (req, res) {res.render("html_film_views/TheImposter", { version: version })})


app.get("/TheLegoBatmanMovie", function (req, res) {res.render("html_film_views/TheLegoBatmanMovie", { version: version })})


app.get("/TheLastDaysonMars", function (req, res) {res.render("html_film_views/TheLastDaysonMars", { version: version })})
...
app.get("/ThePirates!InanAdventurewithScientists!", function (req, res) {res.render("html_film_views/ThePirates!InanAdventurewithScientists!", { version: version })})


app.get("/TheProducers", function (req, res) {res.render("html_film_views/TheProducers", { version: version })})


app.get("/TheRevenant", function (req, res) {res.render("html_film_views/TheRevenant", { version: version })})


app.get("/TheSeaInside", function (req, res) {res.render("html_film_views/TheSeaInside", { version: version })})
...
app.get("/Troy", function (req, res) {res.render("html_film_views/Troy", { version: version })})


app.get("/TurnMeOn,Dammit!", function (req, res) {res.render("html_film_views/TurnMeOn,Dammit!", { version: version })})
...
app.get("/ValhallaRising", function (req, res) {res.render("html_film_views/ValhallaRising", { version: version })})


app.get("/Venom", function (req, res) {res.render("html_film_views/Venom", { version: version })})


app.get("/Victoria", function (req, res) {res.render("html_film_views/Victoria", { version: version })})


app.get("/ViewfromaBlueMoon", function (req, res) {res.render("html_film_views/ViewfromaBlueMoon", { version: version })})


app.get("/WaitingfortheBarbarians", function (req, res) {res.render("html_film_views/WaitingfortheBarbarians", { version: version })})


app.get("/WalktheLine", function (req, res) {res.render("html_film_views/WalktheLine", { version: version })})


app.get("/Watchmen", function (req, res) {res.render("html_film_views/Watchmen", { version: version })})


app.get("/WetheAnimals", function (req, res) {res.render("html_film_views/WetheAnimals", { version: version })})


app.get("/WeatheringwithYou", function (req, res) {res.render("html_film_views/WeatheringwithYou", { version: version })})
...
app.get("/WildBill", function (req, res) {res.render("html_film_views/WildBill", { version: version })})
...
app.get("/ZuluSummer", function (req, res) {res.render("html_film_views/ZuluSummer", { version: version })})
