...
app.get("/303Squadron", function (req, res) {res.render("html_film_views/303Squadron")})
...
app.get("/TheJungleBook", function (req, res) {res.render("html_film_views/TheJungleBook")})
