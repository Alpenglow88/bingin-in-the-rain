const topChunkTextAction = `<!DOCTYPE html>
<html>
...
<body>
  <header class="header sticky sticky--top js-header">
    ...
    <div> <font color="white">-</font></div>
        <div class="grid">
        <ul class="navigation__list navigation__list--inline">
            <li class="navigation__item"><a action="/genre-action" href="/genre-action" class="is-active">Action</a></li>
...
exports.topChunkTextAction = topChunkTextAction