const topChunkTextFantasy = `<!DOCTYPE html>
<html>
  ...
  <header class="header sticky sticky--top js-header">
    ...
    <div> <font color="white">-</font></div>
        ...
        <ul class="navigation__list navigation__list--inline">
            ...
            <li class="navigation__item"><a action="/genre-fantasy" href="/genre-fantasy" class="is-active">Fantasy</a></li>
        </ul>
        <ul class="navigation__list navigation__list--inline">
...
exports.topChunkTextFantasy = topChunkTextFantasy