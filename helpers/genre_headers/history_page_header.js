const topChunkTextHistory = `<!DOCTYPE html>
<html>
...
<body>
  <header class="header sticky sticky--top js-header">
    ...
    <div> <font color="white">-</font></div>
        ...
        <ul class="navigation__list navigation__list--inline">
            <li class="navigation__item"><a action="/genre-history" href="/genre-history" class="is-active">History</a></li>
...
exports.topChunkTextHistory = topChunkTextHistory