const topChunkTextHorror = `<!DOCTYPE html>
<html>
  ...
  <header class="header sticky sticky--top js-header">
    ...
    <div> <font color="white">-</font></div>
        ...
        <ul class="navigation__list navigation__list--inline">
            ...
            <li class="navigation__item"><a action="/genre-horror" href="/genre-horror" class="is-active">Horror</a></li>
...
exports.topChunkTextHorror = topChunkTextHorror