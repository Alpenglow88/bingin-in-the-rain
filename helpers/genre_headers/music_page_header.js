const topChunkTextMusic = `<!DOCTYPE html>
<html>
    ...
    <div> <font color="white">-</font></div>
       <div class="grid">
        ...
        <ul class="navigation__list navigation__list--inline">
            ...
            <li class="navigation__item"><a action="/genre-music" href="/genre-music" class="is-active">Music</a></li>
...
exports.topChunkTextMusic = topChunkTextMusic