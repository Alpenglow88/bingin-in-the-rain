const topChunkTextMystery = `<!DOCTYPE html>
<html>
  ...
  <header class="header sticky sticky--top js-header">
    ...
    <div> <font color="white">-</font></div>
        ...
        <ul class="navigation__list navigation__list--inline">
            ...
            <li class="navigation__item"><a action="/genre-mystery" href="/genre-mystery" class="is-active">Mystery</a></li>
...
exports.topChunkTextMystery = topChunkTextMystery