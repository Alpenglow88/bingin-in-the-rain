const topChunkTextScienceFiction = `<!DOCTYPE html>
<html>
  ...
  <header class="header sticky sticky--top js-header">
    ...
    <div> <font color="white">-</font></div>
        ...
        <ul class="navigation__list navigation__list--inline">
            ...
            <li class="navigation__item"><a action="/genre-animation" href="/genre-animation">Animation</a></li>
        ...
        <ul class="navigation__list navigation__list--inline">
            ...
            <li class="navigation__item"><a action="/genre-science-fiction" href="/genre-science-fiction" class="is-active">SciFi</a></li>
...
exports.topChunkTextScienceFiction = topChunkTextScienceFiction