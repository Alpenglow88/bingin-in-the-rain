const topChunkTextThriller = `<!DOCTYPE html>
<html>
  ...
  <header class="header sticky sticky--top js-header">
    ...
    <div> <font color="white">-</font></div>
        ...
        <ul class="navigation__list navigation__list--inline">
            ...
            <li class="navigation__item"><a action="/genre-thriller" href="/genre-thriller" class="is-active">Thriller</a></li>
...
exports.topChunkTextThriller = topChunkTextThriller