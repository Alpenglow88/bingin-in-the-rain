const topChunkTextWestern = `<!DOCTYPE html>
<html>
  ...
  <header class="header sticky sticky--top js-header">
    ...
    <div> <font color="white">-</font></div>
        ...
        <ul class="navigation__list navigation__list--inline">
            ...
            <li class="navigation__item"><a action="/genre-western" href="/genre-western" class="is-active">Western</a></li>
        </ul>
    </div>
    </header>
...
exports.topChunkTextWestern = topChunkTextWestern